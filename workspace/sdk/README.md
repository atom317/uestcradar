...
cd ../../../
docker build -t registry.chengyistudio.com/cxx/algo-base:1.0.0 -f workspace/sdk/Dockerfile .

# 2. 如果您需要将其标记为最新版本 (可选)
docker tag registry.chengyistudio.com/cxx/algo-base:1.0.0 registry.chengyistudio.com/cxx/algo-base:latest

# 3. 登录并推送至私有源
docker login registry.chengyistudio.com
docker push registry.chengyistudio.com/cxx/algo-base:1.0.0
